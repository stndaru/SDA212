...
public class TP2v3bugged {
    ...
    */
    ...
    /* 
        ...
        ACTUALLY TEBAS GENERATES A SHIT TON OF RTE HOLY FUCK
    */
    ...
    static int Stabilize(){
        ...
        if(currentDataran.next != null){
            ...
            // out.println(targetDataran + "/" + targetDataran.height.value);
            // out.println(treeNode);
            // treeNode.sanityNode(targetDataran);
            // out.println(treeNodeDLL);
            // out.println(treeNodeDLL.next == null);

            //if(treeNodeDLL == null) return 0;//
                ...
                if(node.findDataranNode(dataran) != null || forced){
                    ...
                    if(node.head == null || node.totalDataranInNode <= 0 || forced){
                        ...
                        if (node.prev == null || node.next == null) {
                            ...
                            // out.println(mostprevChild.heightValue.value+"/"); // 
    ...
    static class Node {
        ...
        void removeDataran(Dataran dataran){
            ...
            // out.println(temp == tail);
            // out.println(head == temp);
            // out.println(head.next == tail);
            // out.println(temp.prev);
                ...
                if(direction.equals("KIRI")) {
                    if(currentDataranNode.prev == null){
                        ...
                        if(tempTreeNode == null && tempKuil.prev != null){
                            // after switching to prev, didnt check and instead fell into logic error
                            // maybe just commenting is enough?
