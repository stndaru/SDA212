...
public class Lab3 {
    ...
    */
    ...
    static private long[] findMaxBerlian(ArrayList<Integer> S, ArrayList<Integer> M, ArrayList<Integer> Bo, int N) {
        ...
        if(N > 1){
            ...
            for(int i = 0; i < N+1; i++){
                if(i < N){
                    ...
                    System.out.println(Arrays.toString(cache[i][1]));
                    System.out.println(Arrays.toString(cache[i][2]));
                    System.out.println("");
                }
        ...
        // System.out.println(Arrays.toString(cache[N-1][0]));
        // System.out.println(Arrays.toString(cache[N-1][1]));
        // System.out.println(Arrays.toString(cache[N-1][2]));
        // System.out.println("");
