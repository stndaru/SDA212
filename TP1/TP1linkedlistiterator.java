...
public class TP1linkedlistiterator {
        ...
        for(int inp = 0; inp < N; inp++){
            ...
            for(int j = 0; j < limit; j++){
                ...
                for(int k = 0; k < eval; k++){
                    ...
                    while(iter.hasNext()){
                        tempPerson = iter.next();
                        if(currentIndex < tempPerson.getEarly() || currentIndex < tempPerson.getBefore())
                            tempPerson.addIncreased();
                        
                        tempPerson.setBefore(currentIndex);
                        currentIndex++;
                    }
                    currentIndex = 0;
                }
            ...
            if(evaluate.toUpperCase().equals("PANUTAN")){
                ...
                iterRes = result.iterator();
                if(result.size() != 0){
                    while(iterRes.hasNext()){
                        out.print(iterRes.next() + " ");
                    }
                    out.print("\n");
                }
                else
